...
$error = $success = $b_name = $desc = $book_author = $publishing_year =  $price= '';
...
if (isset($_POST['submit'])) {
    ...
    $publishing_year = htmlspecialchars($_POST['publish']);
    ...
    }elseif (empty ($publishing_year)) {
                $error = "Publishing year please";
    }elseif (empty ($price)) {
                    $error = "Price please";
    } else {
        $sql = "INSERT INTO `books`(`book_name`, `book_desc`, `book_author`, `book_price`, `publishing_year`) VALUES ('$b_name','$desc','$book_author','$price','$publishing_year')";
        if ($conn->query($sql)) {
            $success= 'Added!';
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                                        ...
                                        <div class="mb-2">
                                            <label for="reg_no">Book Author</label>
                                            <input type="text" class="form-control" name="book_author" id="book_author" value="<?php echo $book_author ?>" placeholder="Book Author">
                                        </div>
                                        <div class="mb-2">
                                            <label for="reg_no">Book Price</label>
                                            <input type="text" class="form-control" name="price" id="price" value="<?php echo $price ?>" placeholder="Book Price">
                                        </div>
                                        <div class="mb-2">
                                            <label for="reg_no">Publishing Year</label>
                                            <input type="text" class="form-control" name="publish" id="publish" value="<?php echo $publishing_year ?>" placeholder="Book Price">
                                        </div>
